...
class StyleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textSizeSeekBar.progress = appPreference!!.getItemTextSize()
        lineSpaceSeekBar.progress = appPreference!!.getLineSpace()
        itemSpace.progress = appPreference!!.getItemSpace()

        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
    }

    override fun onDestroy() {
        appPreference?.setBigBangStyle(BigBangStyle(
                itemSpace.progress,
